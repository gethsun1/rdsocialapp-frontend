...
import 'package:foap/screens/settings_menu/legal_document_screen.dart';
                                ...
                                recognizer: TapGestureRecognizer()
                                  ..onTap = () {
                                    Get.to(() => const LegalDocumentScreen(
                                          ...
                                          assetPath:
                                              'assets/legal/rd_privacy_policy.txt',
                                        ));
                                  },
                                style: TextStyle(
                                    fontSize: FontSizes.b4,
  ...
  AppThemeButton addSignUpBtn() {
    return AppThemeButton(
      onPress: () async {
        ...
        await SharedPrefs().setLegalConsent(
          accepted: true,
