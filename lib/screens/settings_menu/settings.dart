...
class _SettingsState extends State<Settings> {
                  ...
                  children: [
                    Column(
                      children: [
                        ...
                        addTileEvent(ThemeIcon.security, privacyString.tr, '',
                            () {
                          Get.to(() => const PrivacyOptions());
                        }, true),
                        addTileEvent(
                            ThemeIcon.terms, termsOfServiceString.tr, '', () {
                          Get.to(() => const LegalDocumentScreen(
                                title: 'Terms of Service',
                                assetPath:
                                    'assets/legal/rd_terms_of_service.txt',
                              ));
                        }, true),
                        addTileEvent(
                            ThemeIcon.privacyPolicy, privacyPolicyString.tr, '',
                            () {
                          Get.to(() => const LegalDocumentScreen(
                                title: 'Privacy Policy',
                                assetPath: 'assets/legal/rd_privacy_policy.txt',
                              ));
                        }, true),
                        addTileEvent(
                            ThemeIcon.setting,
  ...
  InkWell addTileEvent(ThemeIcon icon, String title, String subTitle,
