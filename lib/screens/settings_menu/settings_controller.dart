...
class SettingsController extends GetxController {
  ...
  Future<void> setCurrentSelectedLanguage() async {
  ...
  void redeemCoinValueChange(int coins) {
  ...
  Future<void> appearanceModeChanged(bool status) async {
    await setDarkMode(status);
    appearanceChanged?.value = !appearanceChanged!.value;
  }

  void shareLocationToggle(bool status) {
  ...
  Future<void> getSettings() async {
    await MiscApi.getSettings(resultCallback: (result) async {
      ...
      final latestVersion = setting.value?.latestVersion;

      forceUpdate.value = AppConfigConstants.enforceForceUpdateGate &&
          latestVersion != null &&
          latestVersion.isNotEmpty &&
          latestVersion != AppConfigConstants.currentVersion;
  ...
  void updateAccountPrivacy(bool isPrivate) {
