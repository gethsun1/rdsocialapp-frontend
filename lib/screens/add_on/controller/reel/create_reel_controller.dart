...
class CreateReelController extends GetxController {
  ...
  void selectReelAudio(ReelMusicModel audio) {
    selectedAudio.value = audio;
  }

  void setCroppedAudio(File audioFile) {
    croppedAudioFile = audioFile;
  }

  void setAudioCropperTime(double startTime, double endTime) {
    audioStartTime = startTime;
    audioEndTime = endTime;
  }

  Future<void> playAudio(ReelMusicModel reelAudio) async {
  ...
  Future<void> playAudioFile(File reelAudio) async {
    _playerManager.playAudioFile(reelAudio);
    update();
  }

  Future<void> playAudioFileUntil(ReelMusicModel reelAudio, double startDuration,
  ...
  Future<void> downloadAudio(Function(bool) callback) async {
