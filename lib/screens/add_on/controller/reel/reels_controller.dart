...
class ReelsController extends GetxController {
  ...
  void setCurrentViewingReel(PostModel reel) {
    currentViewingReel.value = reel;
    currentViewingReel.refresh();
    update();
  }

  void currentPageChanged(int index, PostModel reel) {
    setCurrentViewingReel(reel);
  }

  void addReels(List<PostModel> reelsList, int? startPage) {
    filteredReels.clear();
  ...
  void setReelsSearchQuery(PostSearchQuery query) {
