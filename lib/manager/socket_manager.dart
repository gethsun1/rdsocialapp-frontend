...
//******************* Chat ****************************//
  ...
  // group chat
  void leaveGroupChat(dynamic response) {
    response['action'] =
  ...
  void removeUserAdmin(dynamic response) {
    response['action'] =
  ...
  void removeUserFromGroupChat(dynamic response) {
    response['action'] =
  ...
  void makeUserAdmin(dynamic response) {
    response['action'] =
  ...
  void updateChatAccessGroup(dynamic response) {
  ...
  void onReceiveMessageInLiveTv(dynamic response) async {
    ...
    _liveTvStreamingController.newMessageReceived(message);
  }
}
