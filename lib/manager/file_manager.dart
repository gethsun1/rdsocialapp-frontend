...
class FileManager {
  Future<void> deleteMessageMedia(ChatMessageModel message) async {
  ...
  Future<void> multipleDeleteMessageMedia(List<ChatMessageModel> messages) async {
  ...
  Future<void> deleteRoomMedia(ChatRoomModel chatRoom) async {
    final tempDir = await getApplicationDocumentsDirectory();
