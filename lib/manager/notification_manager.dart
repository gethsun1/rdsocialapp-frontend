...
class NotificationManager {
  ...
  void parseNotificationMessage(Map<String?, Object?> message) {
  ...
  Future<void> showHideCallNotifications(Map<String?, Object?> data) async {
  ...
  void handleSimpleNotificationBannerTap(dynamic data, bool isInForeground) {
...
void performActionOnCallNotificationBanner(
