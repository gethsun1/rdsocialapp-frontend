...
class GiftApi {
  static Future<void> getReceivedStickerGifts(
      {required int page,
  ...
  static Future<void> getLiveCallReceivedStickerGifts(
      {required int page,
      required int liveId,
  ...
  static Future<void> getStickerGiftCategories(
  ...
  static Future<void> getStickerGiftsByCategory(int categoryId,
  ...
  static Future<void> getMostUsedStickerGifts(
      {required Function(List<GiftModel>) resultCallback}) async {
  ...
  static Future<void> sendStickerGift(
  ...
  static Future<void> getTimelineReceivedTextGifts(
      {required int page,
      required int sendOnType,
      required int postId,
  ...
  static Future<void> getTimelineTextGifts(
      {required int page,
  ...
  static Future<void> sendTimelineTextGift(
