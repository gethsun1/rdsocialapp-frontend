...
class PodcastApi {
  static Future<void> getPodcastBanners(
  ...
  static Future<void> getPodcastCategories(
  ...
  static Future<void> getHostsList(
      {required int page,
      int? categoryId,
      String? name,
  ...
  static Future<void> getPodcasts(
      {required int page,
      int? podcastId,
      String? name,
  ...
  static Future<void> getPodcastEpisode(
      {required int page,
      int? podcastId,
      String? name,
  ...
  static Future<void> getPodcastById(
  ...
  static Future<void> getPodcastHostById(
      {required int hostId,
