...
class TVModuleApi {
  static Future<void> getTVCategories(
  ...
  static Future<void> getTVShowById(
  ...
  static Future<void> getTVShowEpisodes(
      {int? showId,
      String? name,
  ...
  static Future<void> getTvCategories(int id) async {
  ...
  static Future<void> getTVChannelById(
  ...
  static Future<void> likeUnlikeTv(bool like, int tvId) async {
    var url =
  ...
  static Future<void> getFavLiveTvs(
      {required int page,
      required Function(List<TvModel>, APIMetaData) resultCallback}) async {
  ...
  static Future<void> getSubscribedLiveTvs(
      {required int page,
      required Function(List<TvModel>, APIMetaData) resultCallback}) async {
  ...
  static Future<void> getTvBanners(
  ...
  static Future<void> subscribeTv(
  ...
  static Future<void> stopWatchingTv(
      {required TvModel tvModel,
      required Function(bool) resultCallback}) async {
