...
class SharedPrefs {
  ...
  Future<void> setLegalConsent({
    required bool accepted,
    required String acceptedAtIso,
  }) async {
    SharedPreferences prefs = await SharedPreferences.getInstance();
    await prefs.setBool('legalConsentAccepted', accepted);
    await prefs.setString('legalConsentAcceptedAt', acceptedAtIso);
  }

  Future<bool> getLegalConsentAccepted() async {
    SharedPreferences prefs = await SharedPreferences.getInstance();
    return prefs.getBool('legalConsentAccepted') ?? false;
  }

  Future<String?> getLegalConsentAcceptedAt() async {
    SharedPreferences prefs = await SharedPreferences.getInstance();
    return prefs.getString('legalConsentAcceptedAt');
  }
}
