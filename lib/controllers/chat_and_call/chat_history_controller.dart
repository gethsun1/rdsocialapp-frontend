...
class ChatHistoryController extends GetxController {
  ...
  void refreshPublicGroups(VoidCallback callback) {
    publicGroupsDataWrapper = DataWrapper();
    getPublicChatRooms(callback);
  }

  void loadMorePublicGroups(VoidCallback callback) {
  ...
  Future<void> getPublicChatRooms(VoidCallback callback) async {
  ...
  Future<void> clearUnreadCount({required ChatRoomModel chatRoom}) async {
  ...
  void deleteRoom(ChatRoomModel chatRoom) {
  ...
  void joinPublicGroup(ChatRoomModel room) {
  ...
  void leavePublicGroup(ChatRoomModel room) {
    final UserProfileManager userProfileManager = Get.find();
