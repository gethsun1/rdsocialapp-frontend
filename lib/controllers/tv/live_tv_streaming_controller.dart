...
class TvStreamingController extends GetxController {
  ...
  void setCurrentViewingTv(TvModel tvModel) {
    currentViewingTv.value = tvModel;
    update();
  }

  void segmentChanged(int segment) {
    currentSegment.value = segment;
  }

  void updateBannerSlider(int index) {
  ...
  void getLiveTv({required VoidCallback callback}) {
  ...
  void getTvs({int? categoryId, String? name, required VoidCallback callback}) {
    if (canLoadMoreTvs) {
      TVModuleApi.getTvs(
          page: tvsCurrentPage,
  ...
  void getTvShows({int? liveTvId, String? name}) {
  ...
  void getTvShowById(int showId, Function() completionCallBack) {
  ...
  void getTvChannelById(int tvId, Function() completionCallBack) {
  ...
  void getTvShowEpisodes({int? showId, String? name}) {
  ...
  void playEpisode(TVShowEpisodeModel episode) {
    selectedEpisode.value = episode;
    selectedEpisode.refresh();
  }

  void subscribeTv(TvModel tvModel, Function(bool) completionCallBack) {
  ...
  void stopWatchingTv(TvModel tvModel, Function(bool) completionCallBack) {
  ...
  void sendTextMessage(String messageText, int id) {
  ...
  void addNewMessage(ChatMessageModel message, int tvId) {
