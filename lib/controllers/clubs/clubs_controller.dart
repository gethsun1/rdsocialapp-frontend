...
class ClubsController extends GetxController {
  ...
  void setSearchText(String? name) {
    clear();
    _name = name;
    getClubs();
  }
  ...
  void selectedSegmentIndex({required int index}) {
  ...
  void clubDeleted(ClubModel club) {
    clubs.removeWhere((element) => element.id == club.id);
    clubs.refresh();
  }

  void getMembers({int? clubId}) {
  ...
  void acceptClubInvitation(ClubInvitation invitation) {
  ...
  void declineClubInvitation(ClubInvitation invitation) {
    invitations.remove(invitation);
    invitations.refresh();
    ClubApi.acceptDeclineClubInvitation(
  ...
  void removeMemberFromClub(ClubModel club, ClubMemberModel member) {
  ...
  void deleteClub({required ClubModel club, required VoidCallback callback}) {
    ClubApi.deleteClub(
      club.id!,
    );
    Get.back();
  ...
  void getClubDetail(int clubId, Function(ClubModel) callback) {
