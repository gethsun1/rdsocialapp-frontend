...
class ClubDetailController extends GetxController {
  ...
  void setClub(ClubModel clubObj) {
    club.value = clubObj;
    club.refresh();
  ...
  void getClubJoinRequests({required int clubId}) {
  ...
  void acceptClubJoinRequest(ClubJoinRequest request) {
  ...
  void declineClubJoinRequest(ClubJoinRequest request) {
    joinRequests.remove(request);
    joinRequests.refresh();
    update();
  ...
  void refreshPosts({required int clubId, required VoidCallback callback}) {
    postDataWrapper = DataWrapper();
    getPosts(clubId: clubId, callback: callback);
  }

  void loadMorePosts({required int clubId, required VoidCallback callback}) {
