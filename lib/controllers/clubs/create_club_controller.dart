...
class CreateClubController extends GetxController {
  ...
  void privacyTypeChange(int type) {
  ...
  Future<void> createClub(ClubModel club, Function(int) callback) async {
  ...
  Future<void> updateClubImage(ClubModel club, BuildContext context,
  ...
  void updateClubInfo({required ClubModel club, required VoidCallback callback}) {
    EasyLoading.show(status: loadingString.tr);
