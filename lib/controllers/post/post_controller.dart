...
class PostController extends GetxController {
  ...
  void clearPostLikedByUsers() {
    likedByUsers.clear();
    postLikedByDataWrapper = DataWrapper();
  }

  void addPosts(List<PostModel> postsList, int? startPage, int? totalPages) {
  ...
  void setMentionedPostSearchQuery(MentionedPostSearchQuery query) {
