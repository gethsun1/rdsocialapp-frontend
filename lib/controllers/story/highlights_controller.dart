...
class HighlightsController extends GetxController {
  ...
  void setCurrentHighlight(HighlightsModel highlight) {
    currentHighlight.value = highlight;
  }

  void setCurrentStoryMedia(HighlightMediaModel storyMedia) {
  ...
  Future<void> createHighlights({required String name}) async {
  ...
  Future<void> deleteStoryFromHighlight() async {
