...
class UserSubscriptionController extends GetxController {
  ...
  void setExistingSubscriptionCost() {
  ...
  void selectSubscriptionCoins(int value) {
  ...
  void loadMoreSubscribers(VoidCallback callback) {
  ...
  void getMySubscribers(VoidCallback callback) {
  ...
  void loadMoreSubscriptions(VoidCallback callback) {
  ...
  void getMySubscriptions(VoidCallback callback) {
    var id = _userProfileManager.user.value!.id;
