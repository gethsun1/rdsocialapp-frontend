...
class PodcastStreamingController extends GetxController {
  ...
  void getPodcasts({int? podcastId, String? name, required VoidCallback callback}) {
  ...
  void getPodcastById(int id, Function(PodcastModel) completionCallBack) {
  ...
  void getHostById(int hostId, Function(HostModel) completionCallBack) {
    EasyLoading.show(status: loadingString.tr);
