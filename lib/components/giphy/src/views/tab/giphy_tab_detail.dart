...
import 'package:foap/components/giphy/src/client/client.dart';
import 'package:foap/components/giphy/src/client/models/collection.dart';
import 'package:foap/components/giphy/src/client/models/gif.dart';
...
class GiphyTabDetail extends StatefulWidget {
  ...
  const GiphyTabDetail({super.key, required this.type, required this.scrollController});

  @override
  GiphyTabDetailState createState() => GiphyTabDetailState();
}

class GiphyTabDetailState extends State<GiphyTabDetail> {
  // Tab Provider
