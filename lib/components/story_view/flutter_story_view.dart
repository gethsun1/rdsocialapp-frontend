...
import 'package:foap/components/story_view/widgets/story_image.dart';
import 'package:foap/components/story_view/widgets/story_indicator.dart';
import 'package:foap/components/story_view/widgets/story_video.dart';
...
class FlutterStoryView extends StatefulWidget {
  ...
  final FlutterStoryViewController controller;
...
class _FlutterStoryViewState extends State<FlutterStoryView>
  ...
  void _startAnimation(int index, {Duration? duration}) {
    ...
    _animation = Tween<double>(begin: 0, end: 1)
        .animate(widget.controller.animationController!)
      ..addListener(() {
        setState(() {
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: GestureDetector(
        ...
        //   if (details.globalPosition.dy > 250) {
        //    // widget.onComplete();
  ...
  Column _storyItem(StoryItem story) {
    return Column(
      children: [
        // AnimatedOpacity(
        //   duration: const Duration(milliseconds: 200),
          ...
          child: Stack(
            children: [
              ...
              _switchStoryItemIsVideoOrImage(
                ...
                type: story.type,
                controller:
                    widget.controller.videoController, // Pass the controller
              ),
  ...
  StatefulWidget _switchStoryItemIsVideoOrImage(
    String url, {
          ...
          Container(
            ...
            decoration: const BoxDecoration(
              gradient: LinearGradient(
                ...
                colors: [
                  Colors.black, // Change colors as needed
                  Colors.transparent, // Center will be transparent
                ],
              ),
            ),
          ),
