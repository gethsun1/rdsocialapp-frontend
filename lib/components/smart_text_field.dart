...
class SmartTextFieldController extends GetxController {
  ...
  void textChanged(String text, int position) {
    clear();
    isEditing.value = 1;
  ...
  void searchHashTags({required String text, VoidCallback? callBackHandler}) {
  ...
  void replaceTextInString(String text, bool isHashtag) {
